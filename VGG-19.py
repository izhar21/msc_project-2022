...
# Desing VGG-19 architecture 
def createAModel():
# The sequential model of keras is used
    model = Sequential()
    
# 1st Convolution layer with 64 filters
    model.add(Conv2D(64, kernel_size=(11,11), padding='same', 
...
#6th Convolution layer with 256 filters
    model.add(Conv2D(256, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))

#7th Convolution layer with 256 filters
    model.add(Conv2D(256, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))  

#8th Convolution layer with 256 filters
    model.add(Conv2D(256, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu')) 
...
#9th Convolution layer with 512 filters
    model.add(Conv2D(512, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))  

#10th Convolution layer with 512 filters
    model.add(Conv2D(512, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))   

#11th Convolution layer with 512 filters
    model.add(Conv2D(512, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))       
...
#14th Convolution layer with 512 filters
    model.add(Conv2D(512, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))    

#15th Convolution layer with 512 filters
    model.add(Conv2D(512, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))    

#16th Convolution layer with 512 filters
    model.add(Conv2D(512, kernel_size=(1,1), padding='same',
                     kernel_initializer='glorot_uniform', 
                     bias_initializer='zeros'))
    model.add(Activation('relu'))                      
